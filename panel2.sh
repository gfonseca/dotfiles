         ...
         for i in "${TAGS[@]}" ; do
            ...
            case ${i:0:1} in
             ...
             #echo -n "  ^bg(#178FD1) ^bg(#c3c3cc)^fg(#0A0A0A)  ➜ ${i:1}  ^bg(#178FD1) ^bg(#0A0A0A)"
               ;;
            '#')
               echo -n "  ^bg(#0088CC) ^bg(#c3c3cc)^fg(#0A0A0A)  ➜ ${i:1}  ^bg(#0088CC) ^bg(#0A0A0A)"
               ;;
            ':')
               echo -n "  ^bg(#0088CC) ^bg(#0A0A0A)^fg(#FFFFFF)  ${i:1}  ^bg(#0088CC) ^bg(#0A0A0A)"
               ;;
           '!')
               echo -n "  ^bg(#0088CC) ^bg(#c3c3cc)^fg(#0A0A0A)  • ${i:1}  ^bg(#0088CC) ^bg(#0A0A0A)"
               ;;
            *)
                 echo -n "  ^bg(#0088CC) ^bg(#0A0A0A)^fg(#CCCCCC)  ${i:1}  ^bg(#0088CC) ^bg(#0A0A0A)"
               ;;
